...
namespace NetTopologySuite.IO.GeoJSON.Test
{
    ...
    public class GeoJsonSerializerTest
    {
        ...
        public void TestFactoryMethods()
        {
            ...
            Assert.That(() => GeoJsonSerializer.Create(factory, 1, 0), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(factory, 2, 1), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(factory, 2, 0), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(factory, 3, 0), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(factory, 3, 2), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(factory, 4, 0), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 1, 0), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 2, 1), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 2, 0), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 3, 0), Throws.Nothing);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 3, 2), Throws.ArgumentException);
            Assert.That(() => GeoJsonSerializer.Create(settings, factory, 4, 0), Throws.Nothing);
        }
